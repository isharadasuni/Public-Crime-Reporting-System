...
const AddPoliceStation = () => {
    ...
    const handleSubmitClick = async (e) => {
        ...
        try {
            ...
            const locationData = await PoliceLocationDataService.getAllLocation();
            ...
            if (!isLat || !isLng) {
                ...
                await PoliceLocationDataService.addlocation(addNewLocation);
    ...
    const deleteHandler = async (id) => {
        try {
            await PoliceLocationDataService.deleteLocation(id);
            fetchLocation();
                    ...
                    <div className="contentBox">
                        <div className="datatable">
                            ...
                            {location && location.length > 0 ? (
                                <DataGrid
                                    ...
                                    rows={location}
                                    columns={[
                                        { field: "depatment_Name", headerName: " Department", width: 200 },
                        ...
                        <div>
                            ...
                            <div className="formInput">
                                ...
                                <input type="text" id="department" onChange={(e) => setNewName(e.target.value)} required/>
                            </div>
